...
import com.adjara.app.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class FullScreenSerie extends Activity {
    /**
    ...
    private void PlayVideo()
    {
        try
        {
            ...
            MediaController mediaController = new MediaController(FullScreenSerie.this);
