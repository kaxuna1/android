...
public class CardCursorContract {
    ...
    public static class CardCursor{
        ...
        public static final String CONTENT_TYPE =   ContentResolver.CURSOR_DIR_BASE_TYPE +"/vnd.com.adjaran.app.CardCursor";
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.adjaran.app.CardCursor";
