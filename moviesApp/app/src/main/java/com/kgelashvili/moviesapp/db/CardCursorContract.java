...
package com.kgelashvili.moviesapp.db;
...
public class CardCursorContract {
    ...
    public static class CardCursor{
        ...
        public static final String CONTENT_TYPE =   ContentResolver.CURSOR_DIR_BASE_TYPE +"/vnd.com.kgelashvili.moviesapp.CardCursor";
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.kgelashvili.moviesapp.CardCursor";
