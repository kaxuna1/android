...
import com.kgelashvili.moviesapp.fragment.v1.MaterialV1Fragment;
...
public class NativeChangeValueCardFragment extends MaterialV1Fragment {
    ...
    private CardViewNative cardView1;
    private CardViewNative cardView2;
    private CardViewNative cardView3;
    private CardViewNative cardView4;

    @Override
    protected int getSubTitleHeaderResourceId() {
        return R.string.header_title_subtitle_ex_refresh;
    }
    ...
    protected String getSourceUrl() {
        return "https://github.com/gabrielemariotti/cardslib/blob/master/demo/stock/src/main/java/it/gmariotti/cardslib/demo/fragment/native/NativeChangeValueCardFragment.java";
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.demo_fragment_native_changevalue, container, false);
    }
