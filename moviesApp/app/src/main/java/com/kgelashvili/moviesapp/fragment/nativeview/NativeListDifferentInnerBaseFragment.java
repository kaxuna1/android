...
import com.kgelashvili.moviesapp.cards.MayKnowCard;
 ...
 */
public class NativeListDifferentInnerBaseFragment extends BaseMaterialFragment {

    protected ScrollView mScrollView;

    @Override
    protected int getSubTitleHeaderResourceId() {
        return R.string.header_title_subtitle_ldiff;
    }
    ...
    protected String getSourceUrl() {
        return "https://github.com/gabrielemariotti/cardslib/blob/master/demo/stock/src/main/java/it/gmariotti/cardslib/demo/fragment/nativeview/NativeListDifferentInnerBaseFragment.java";
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.demo_fragment_native_list_base_different_inner, container, false);
    }
