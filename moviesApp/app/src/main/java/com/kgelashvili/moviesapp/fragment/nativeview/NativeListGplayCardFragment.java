 ...
 */
public class NativeListGplayCardFragment extends BaseNativeListFragment {
    ...
    protected int getSubTitleHeaderResourceId() {
        return R.string.header_title_subtitle_lgplay;
    }
    ...
    protected String getSourceUrl() {
        return "https://github.com/gabrielemariotti/cardslib/blob/master/demo/stock/src/main/java/it/gmariotti/cardslib/demo/fragment/nativeview/NativeListGplayCardFragment.java";
    }
